...
# new_url = "https://github.com/DataTalksClub/nyc-tlc-data/releases/download/green/green_tripdata_2021-07.csv.gz"


# Starting with the green taxis
...
OUTPUT_FILE_NAME = "green_taxi_{{ execution_date.strftime('%Y-%m') }}"
